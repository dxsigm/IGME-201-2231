...
namespace BTree
{
    ...
    public class BTree
    {
        ...
        // does not work!
        public static void BreadthFirstDownTopTraversal(BTree node, ref Stack<BTree> stack)
        {
            if(node != null)
            {
                stack.Push(node);
                BreadthFirstDownTopTraversal(node.gteChild, ref stack);
                BreadthFirstDownTopTraversal(node.ltChild, ref stack);
            }
        }
    }
